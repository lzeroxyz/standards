...
export interface ERC1155MetadataGlobalURIMockInterface extends utils.Interface {
  contractName: 'ERC1155MetadataGlobalURIMock';
  functions: {
    '_approvals(address,address)': FunctionFragment;
    '_balances(address,uint256)': FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: '_approvals', data: BytesLike): Result;
...
export interface ERC1155MetadataGlobalURIMock extends BaseContract {
  contractName: 'ERC1155MetadataGlobalURIMock';
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155MetadataGlobalURIMockInterface;
